import '../get_recipes_screen_two_screen/widgets/recipecardlist_item_widget.dart';
...
class GetRecipesScreenTwoScreen extends StatelessWidget {
  GetRecipesScreenTwoScreen({Key? key}) : super(key: key);
    ...
    return Expanded(
        child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return RecipecardlistItemWidget(onTapImgRecipeImage: () {
